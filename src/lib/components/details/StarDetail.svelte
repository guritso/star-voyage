            ...
            <div class="space-y-2">
                ...
                <div class="grid grid-cols-1 gap-2">
                    ...
                    {#if star.constellation}
                        <div
                            class="flex justify-between items-center py-2 px-3 bg-gray-800 rounded-lg"
                        >
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        {#if star.decDeg}
                            <div class="bg-gray-800 rounded-lg p-3 text-center">
                                ...
                                <div class="text-gray-200 font-mono font-medium">
                                    {star.decDeg.toFixed(2)}°
                                </div>
                            </div>
                        {/if}
                    </div>
